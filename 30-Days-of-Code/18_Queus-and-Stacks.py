# Written: 30-Jan-2020
'''
* Resource: https://www.hackerrank.com/challenges/30-queues-stacks/tutorial
*
* Task
...
*   If your code is correctly written and s is a palindrome, the locked stub code will print ; otherwise, it will print
